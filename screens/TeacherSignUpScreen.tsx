...
const UNIVERSITIES = [
  { label: 'Quantum University', value: 'quantum' },
  { label: 'Metropolis Institute of Technology', value: 'metropolis' },
  { label: 'Starlight College of Arts', value: 'starlight' },
        ...
        <View style={styles.mainContent}>
          {/* Headline */}
            <Animated.View entering={FadeInUp.delay(100)} style={styles.headlineSection}>
              <Text style={styles.headline}>Create Teacher Account</Text>
              <Text style={styles.subtitle}>Get started managing your classes</Text>
            </Animated.View>
            ...
            <Animated.View entering={FadeInUp.delay(300)} style={styles.formCard}>
              {/* University - First field for teachers */}
              <View style={styles.formGroup}>
                ...
                >
                  ...
                  <Text style={[
                    ...
                    university && styles.textInputValue,
                  ]}>
                    ...
                    <View style={styles.modalContent}>
                      ...
                      <ScrollView style={styles.modalList}>
                        {UNIVERSITIES.map((uni) => (
                          ...
                          >
                            <Text style={styles.modalOptionText}>{uni.label}</Text>
                            {university === uni.label && (
